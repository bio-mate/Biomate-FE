...
export const genderOptions = [
  { label: "Male", value: "male", icon: "/groom.png" },
  { label: "Female", value: "female", icon: "/bride.png" },
];
...
export const incomeOptions = [
  ...
  { label: "30-40 LPA", value: "30-40 LPA" },
  { label: "More than 40 LPA", value: "More than 40 LPA" },
];
export const employeeInOptions = [
